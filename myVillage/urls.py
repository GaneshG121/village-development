...
urlpatterns = [
                  ...
                  #url(r'pro/', include('problems.urls')),
                  ...
                  url(r'^accounts/logout/$', views.logout, name='logout', kwargs={'next_page': '/'}), ] + static(
    settings.STATIC_URL, document_root=settings.STATIC_ROOT)  # including URL's of static files
